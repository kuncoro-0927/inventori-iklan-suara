...
function Scrub(e) {
    ...
    try {
      !(function (r) {
              ...
              (function (r, l, n) {
                if ("DIV" == l) {
                  ...
                  if (
                    ...
                    (o.style.width = c + "px"),
                    null != e.alt &&
                      o.setAttribute("alt", 0 == n ? e.alt[0] : e.alt[1]),
                    null != e.src)
                  ) {
                  ...
                  (null != e.src && (s = 0 == n ? e.src[0] : e.src[1]),
                    r.parentNode.removeChild(r));
                  var i = document.createElement("div");
                  ((i.className =
                    0 == n
        ...
        ((r.className = "sliding handleOn "),
          ...
          t.appendChild(r),
          0 == e.handle &&
            ((r.innerHTML = ""), r.classList.remove("handleOn")));
        var l = debounce(function (e, t, l) {
          if (r) {
            var c = t - e;
            l.querySelectorAll(".sliding")[0].style.left =
              (e > 0 ? e : 0) + "px";
            l.querySelectorAll(".scrub-left")[0].style.width =
              (e > 0 ? e : 0) + "px";
            l.querySelectorAll(".scrub-right")[0].style.width =
              (c > 0 ? c : 0) + "px";
          }
        }, 1);
  ...
  isObject(e) || "object" == typeof e
    ? ((e.target =
        void 0 === e.target || (!isObject(e) && "object" != typeof e)
          ? null
          : e.target),
      (e.height =
        void 0 === e.height || (!isObject(e) && "object" != typeof e)
          ? "500px"
          : e.height),
      (e.handle =
        void 0 === e.handle ||
        ...
        e.handle),
      (e.src =
        void 0 === e.src || (!isObject(e) && "object" != typeof e)
          ? null
          : e.src),
      (e.alt =
        void 0 === e.alt || (!isObject(e) && "object" != typeof e)
          ? null
          : e.alt),
      t())
    : t();
