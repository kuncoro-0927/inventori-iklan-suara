  ...
  if (isObject(scrubArg) || typeof scrubArg == "object") {
    ...
    scrubArg.handle =
      ...
      (isObject(scrubArg) || typeof scrubArg == "object")
        ...
        : true;
    scrubArg.src =
      typeof scrubArg.src !== "undefined" &&
      (isObject(scrubArg) || typeof scrubArg == "object")
        ? scrubArg.src
        : null;
    scrubArg.alt =
      typeof scrubArg.alt !== "undefined" &&
      (isObject(scrubArg) || typeof scrubArg == "object")
        ? scrubArg.alt
        : null;
  ...
  function ScrubInitiate() {
    ...
    try {
      function utilityFn(callback) {
        ...
        if (
          scrubName.indexOf(".") > -1 &&
          document.querySelectorAll(scrubName).length > 1
        ) {
          console.warn(
        ...
        if (scrubSlider != undefined) {
          ...
          function createScrubImages(el, type, index) {
            if (type == "DIV") {
              ...
              scrubCont.className =
                index == 0
                  ? "scrub-content scrub-left"
                  : "scrub-content scrub-right";
              ...
              if (scrubArg.alt != null) {
                scrubImage.setAttribute(
                  "alt",
                  index == 0 ? scrubArg.alt[0] : scrubArg.alt[1],
                );
              }
