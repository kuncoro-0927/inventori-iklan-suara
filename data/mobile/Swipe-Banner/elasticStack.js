...
(function (window) {
  ...
  ElastiStack.prototype._setStackStyle = function () {
    ...
    if (item2) {
      ...
      setTransformStyle(
        item2,
        is3d ? "translate3d(0,0,-60px)" : "translate(0,0)",
      );
    }
    ...
    if (item3) {
      ...
      setTransformStyle(
        item3,
        is3d ? "translate3d(0,0,-120px)" : "translate(0,0)",
      );
    }
  };
  ...
  ElastiStack.prototype._moveAway = function (instance) {
    ...
    var self = this,
      onEndTransFn = function () {
        ...
        setTransformStyle(
          instance.element,
          is3d ? "translate3d(0,0,-180px)" : "translate(0,0,0)",
        );
        ...
        // reorder stack
        self.current =
          self.current < self.itemsCount - 1 ? self.current + 1 : 0;
        // new front items
  ...
  ElastiStack.prototype._moveBack = function (instance) {
    ...
    setTransformStyle(
      instance.element,
      is3d ? "translate3d(0,0,0)" : "translate(0,0)",
    );
  ...
  ElastiStack.prototype._outOfBounds = function (el) {
    return (
      Math.abs(el.position.x) > this.options.distDragMax ||
  ...
  ElastiStack.prototype._outOfSight = function (el) {
    return (
      Math.abs(el.position.x) > this.options.distDragBack ||
