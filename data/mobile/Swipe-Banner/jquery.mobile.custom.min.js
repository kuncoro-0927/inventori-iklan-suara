        ...
        _getCreateOptions: function () {
          ...
          if (!e.mobile.getAttribute(s, "defaults"))
            for (t in this.options)
              ((i = e.mobile.getAttribute(s, t.replace(n, r))),
                i != null && (o[t] = i));
          return o;
        },
      }),
      ...
      ((e.mobile.path = r =
        {
          ...
          getLocation: function (e) {
            ...
            return (
              ...
              n.protocol +
                t.doubleSlash +
                n.host +
                (n.protocol !== "" && n.pathname.substring(0, 1) !== "/"
                  ? "/"
                  : "") +
                n.pathname +
                n.search +
          ...
          isSameDomain: function (e, t) {
            return (
              r.parseUrl(e).domain.toLowerCase() ===
              r.parseUrl(t).domain.toLowerCase()
            );
          },
            ...
            return (
              r.isEmbeddedPage(i)
                ? (n = i.hash
                    ...
                    .replace(/^#/, "")
                    .replace(/\?.*$/, ""))
                : r.isSameDomain(i, this.documentBase) &&
                  (n = i.hrefNoHash
          ...
          isExternal: function (e) {
            ...
            return (
              !!t.protocol &&
              t.domain.toLowerCase() !== this.documentUrl.domain.toLowerCase()
            );
          },
          ...
          isEmbeddedPage: function (e) {
            ...
            return t.protocol !== ""
              ? !this.isPath(t.hash) &&
                  t.hash &&
                  (t.hrefNoHash === this.documentUrl.hrefNoHash ||
                    (this.documentBaseDiffers &&
                      t.hrefNoHash === this.documentBase.hrefNoHash))
              : /^#/.test(t.href);
          },
          squash: function (e, t) {
            var n,
            ...
            (t ||
              (a
                ? (t = r.getLocation())
                : ((u = r.getDocumentUrl(!0)),
                  r.isPath(u.hash) ? (t = r.squash(u.href)) : (t = u.href))),
              (i = a ? r.stripHash(e) : e),
              (i = r.isPath(f.hash) ? r.stripHash(f.hash) : i),
              (o = i.indexOf(this.uiStateKey)),
              o > -1 && ((c = i.slice(o)), (i = i.slice(0, o))),
              (n = r.makeUrlAbsolute(i, t)),
              (s = this.parseUrl(n).search));
            if (a) {
              if (
                r.isPath(l) ||
                l.replace("#", "").indexOf(this.uiStateKey) === 0
              )
                l = "";
              (c && l.indexOf(this.uiStateKey) === -1 && (l += c),
                l.indexOf("#") === -1 && l !== "" && (l = "#" + l),
                (n = r.parseUrl(n)),
                (n = n.protocol + n.doubleSlash + n.host + n.pathname + s + l));
          ...
          isFirstPageUrl: function (t) {
            var i = r.parseUrl(r.makeUrlAbsolute(t, this.documentBase)),
              s =
                i.hrefNoHash === this.documentUrl.hrefNoHash ||
                (this.documentBaseDiffers &&
                  i.hrefNoHash === this.documentBase.hrefNoHash),
          ...
          isPermittedCrossDomainRequest: function (t, n) {
            return (
              e.mobile.allowCrossDomainPages &&
              (t.protocol === "file:" || t.protocol === "content:") &&
              n.search(/^https?:/) !== -1
            );
          },
        }),
        (r.documentUrl = r.parseLocation()),
        (i = e("head").find("base")),
        (r.documentBase = i.length
          ? r.parseUrl(r.makeUrlAbsolute(i.attr("href"), r.documentUrl.href))
          : r.documentUrl),
        (r.documentBaseDiffers =
          r.documentUrl.hrefNoHash !== r.documentBase.hrefNoHash),
        (r.getDocumentBase = function (t) {
    ...
    (function (e, t) {
      ...
      ((e.widget = (function (n) {
        return function () {
          ...
          return (
            (r.initSelector =
              r.prototype.initSelector !== t
                ? r.prototype.initSelector
                : ":jqmData(role='" + i + "')"),
        ...
        e.extend(e.widget, n),
        e.mobile.document.on("create", function (t) {
        ...
        e.widget("mobile.page", {
          ...
          _create: function () {
            ...
            (this.options.enhanced || this._enhance(),
              ...
              e.mobile.getAttribute(this.element[0], "role") === "dialog" &&
                e.mobile.dialog &&
                this.element.dialog());
          },
          _enhance: function () {
            ...
            (this.options.role &&
              ...
              this.element.find("[" + n + "role='content']").each(function () {
                ...
                ((r.options.contentTheme =
                  s ||
                  r.options.contentTheme ||
                  (r.options.dialog && r.options.theme) ||
                  (r.element.jqmData("role") === "dialog" && r.options.theme)),
                  i.addClass("ui-content"),
                  r.options.contentTheme &&
                    i.addClass("ui-body-" + r.options.contentTheme),
                  i.attr("role", "main").addClass("ui-content"));
              }));
          },
          bindRemove: function (t) {
            var n = this.element;
            !n.data("mobile-page").options.domCache &&
              n.is(":jqmData(external-page='true')") &&
              n.bind(
                "pagehide.remove",
                t ||
                  function (t, n) {
          ...
          _setOptions: function (n) {
            (n.theme !== t &&
              this.element
                ...
                .addClass("ui-page-theme-" + n.theme),
              n.contentTheme !== t &&
                this.element
                  .find("[data-" + e.mobile.ns + "='content']")
                  .removeClass("ui-body-" + this.options.contentTheme)
                  .addClass("ui-body-" + n.contentTheme));
          },
          ...
          setContainerBackground: function (e) {
            this.element
              .parent()
              .pagecontainer({ theme: e || this.options.theme });
          },
