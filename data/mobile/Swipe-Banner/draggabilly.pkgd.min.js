...
((function (t) {
          ...
          if (s.hasOwnProperty(o))
            for (i = s[o].length; i--; )
              ((n = s[o][i]),
                ...
                (r === this._getOnceReturnValue() || n.once === !0) &&
  ...
  (function (t) {
    ...
    function i(t) {
      function i(t) {
        if (
          ...
          for (
            var d = (h.isBorderBox = !(!a || !i[a] || "border-box" !== i[a])),
              u = 0,
              c = s.length;
            c > u;
            u++
          ...
          var P = e(i.height);
          return (
            P !== !1 && (h.height = P + (x ? 0 : v + b)),
            (h.innerWidth = h.width - (g + E)),
    ...
    "function" == typeof define && define.amd
      ? define(["get-style-property/get-style-property"], i)
  ...
  (function (t) {
    ...
    function i(i, o, s, d, u) {
      ...
      ((f.prototype._getPosition = function () {
        ...
        (f.prototype.dragStart = function (e, n) {
          if (this.isEnabled) {
            ...
            ((this.pointerIdentifier = n.identifier),
              this._getPosition(),
              ...
              i.add(this.element, "is-dragging"),
              (this.isDragging = !0),
              this.emitEvent("dragStart", [this, e, n]),
              this.animate());
          }
        }),
        ...
        (f.prototype.dragMove = function (t, e) {
          if (
            ...
            ((this.dragPoint.x = Math.max(this.dragPoint.x, -n)),
              (this.dragPoint.y = Math.max(this.dragPoint.y, -i)),
              (this.dragPoint.x = Math.min(
                this.dragPoint.x,
                this.containerSize.width - n - this.size.width,
              )),
              (this.dragPoint.y = Math.min(
                this.dragPoint.y,
                this.containerSize.height - i - this.size.height,
              )));
          }
        ...
        (f.prototype.dragEnd = function (t, e) {
          ((this.isDragging = !1),
            ...
            this._unbindEvents(),
            i.remove(this.element, "is-dragging"),
      ...
      return (
        (f.prototype.setLeftTop = function () {
          ((this.element.style.left = this.position.x + "px"),
            (this.element.style.top = this.position.y + "px"));
        }),
        (f.prototype.positionDrag = g
          ? function () {
              this.element.style[g] = E(this.dragPoint.x, this.dragPoint.y);
            }
          : f.prototype.setLeftTop),
