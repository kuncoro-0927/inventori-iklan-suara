    ...
    function (a, b, c) {
      var d,
        ...
        Q = function (a) {
          (E.push(a),
            1 === E.length &&
              b.ticker.addEventListener("tick", P, this, !1, 1));
        },
        R = function (a) {
        ...
        Ma = function (a) {
          ((e = a.touches && I < a.touches.length),
            Ka(a.target, "touchend", Ma));
        },
        Na = function (a) {
          ((e = a.touches && I < a.touches.length),
            Ja(a.target, "touchend", Ma));
        },
        ...
        Ta = function (d, g) {
          ...
          var h,
            ...
            fb = function () {
              ...
              ((s = !1),
                ...
                g.liveSnap &&
                  ...
                  za
                    ? ((ea = nb(e ? c : c.rotation, y, w, 1)), (fa = null))
                    : c.points
                      ? (ga = ob(
                          e ? c : c.points,
                          y,
            ...
            gb = function () {
              ((Ma.isThrowing = !1),
                ja(Ma, "throwcomplete", "onThrowComplete"));
            },
            hb = function () {
              Ma.isThrowing = !1;
            },
            ...
            kb = function () {
              ...
              (jb(!1),
                ...
                ba && (rb(Ma.pointerX, Ma.pointerY), db(!0)),
                i
                  ? (fb(), (r = i.top()), (l = i.left()))
                  ...
                  l && !m
                    ...
                    : (ib(g.throwProps),
                      C ||
                        ...
                        l.preventManipulation && l.preventManipulation()),
                      ja(Ma, "release", "onRelease")),
                  lb() && n.duration(Ma.tween.duration()),
          ...
          ((da = Ta.get(this.target)),
            ...
            (this.update = function (a, b, c) {
              ...
              return (
                jb(!b),
                a ? Ma.applyBounds() : (ba && c && db(!0), eb(!0)),
                b && (rb(Ma.pointerX, Ma.pointerY), ba && db(!0)),
                Ma.isPressed &&
                  !b &&
                  ...
                  kb(),
                Ma.autoScroll &&
                  ($(d.parentNode), (Wa = Ma.isDragging), db(!0)),
                Ma.autoScroll && (X(d, tb), W(d, tb)),
                Ma
              );
            }),
