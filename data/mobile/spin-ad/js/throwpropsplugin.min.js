            ...
            R =
              s.ease instanceof i
                ...
                : s.ease
                  ? new i(s.ease)
                  : e.defaultEase,
            A = isNaN(C.checkpoint) ? 0.05 : Number(C.checkpoint),
            M = isNaN(C.resistance)
              ? l.defaultResistance
              : Number(C.resistance);
          for (f in C)
            "resistance" !== f &&
                ...
                P && P.isTrackingProp(f)
                  ? (p =
                      "number" == typeof p
                        ...
                        : {
                            velocity: P.getVelocity(f),
                          })
                  : ((y = Number(p) || 0), (_ = y * M > 0 ? y / M : y / -M))),
              "object" == typeof p &&
                (void 0 !== p.velocity && "number" == typeof p.velocity
                  ? (y = Number(p.velocity) || 0)
                  : ((P = P || r.getByTarget(t)),
                    (y = P && P.isTrackingProp(f) ? P.getVelocity(f) : 0)),
                (x = isNaN(p.resistance) ? M : Number(p.resistance)),
                (_ = y * x > 0 ? y / x : y / -x),
                (T =
                  "function" == typeof t[f]
                    ? t[
                        f.indexOf("set") ||
                        "function" != typeof t["get" + f.substr(3)]
                          ? f
                          : "get" + f.substr(3)
                      ]()
                    : t[f] || 0),
                ...
                void 0 !== p.end &&
                  ((p = d(p, w, p.max, p.min)),
                  (h || c) && (C[f] = g(p, C[f], "end"))),
                void 0 !== p.max && w > Number(p.max) + u
                  ? ((S = p.unitFactor || l.defaultUnitFactors[f] || 1),
                    (b =
                      (T > p.max && p.min !== p.max) ||
                      (y * S > -15 && 45 > y * S)
                        ? o + 0.1 * (n - o)
            ...
            e._registerComplexSpecialProp("throwProps", {
              parser: function (t, e, h, u, f, c) {
                  ...
                  "resistance" !== g &&
                    ...
                    "object" == typeof d
                      ? (void 0 !== d.velocity && "number" == typeof d.velocity
                          ? (y[g] = Number(d.velocity) || 0)
                          : ((v = v || r.getByTarget(t)),
                            (y[g] =
                              v && v.isTrackingProp(g) ? v.getVelocity(g) : 0)),
                        void 0 !== d.end && (w[g] = d.end),
                        void 0 !== d.min && (x[g] = d.min),
                        void 0 !== d.max && (T[g] = d.max),
                        d.preventOvershoot && (P[g] = !0),
                        void 0 !== d.resistance &&
                          ((_ = !0), (b[g] = d.resistance)))
                      : "number" == typeof d
                        ? (y[g] = d)
                        : ((v = v || r.getByTarget(t)),
                          (y[g] =
                            v && v.isTrackingProp(g)
                              ? v.getVelocity(g)
                              : d || 0)),
                    p[g] && u._enableTransforms(2 === p[g]));
                ((m = i(t, y, u, f, c)), (s = m.proxy), (y = m.end));
                for (g in s)
                  n[g] = {
                    velocity: y[g],
                    min: x[g],
                ...
                return (
                  ...
                  (f = new a(t, "throwProps", 0, 0, m.pt, 2)),
                  u._overwriteProps.pop(),
                  (f.plugin = c),
                  (f.setRatio = o),
                  (f.data = m),
                  c._onInitTween(s, n, u._tween),
                  f
                );
              },
            });
          ...
          return (
            ...
            u.vars.css
              ? (u.duration(
                ...
                u._delay && !u.vars.immediateRender
                  ? u.invalidate()
                  : o._onInitTween(s, a, u),
                (c = !1),
                u)
              : (u.kill(), (u = new e(t, y(t, i, r, l, h), i)), (c = !1), u)
          );
        }),
          ...
          for (s in e)
            if (
              ...
              if (((n = e[s]), "number" == typeof n)) u = Number(n) || 0;
                ...
                if (((v = v || r.getByTarget(t)), !v || !v.isTrackingProp(s)))
                  throw (
      ...
      function (t) {
        var e,
          ...
          p = function (t) {
            ((this._lookup = {}),
              ...
              i ||
                (u.addEventListener("tick", c, null, !1, -100),
                (r = s = u.time),
                (i = !0)),
        ...
        return (
          (d.addProp = function (e, i) {
            if (!this._lookup[e]) {
              ...
              ((this._firstVP =
                ...
                this._lookup[n] =
                o =
                  new f(n !== e && 0 === e.indexOf("set") ? n : e, s, o)),
                (o.css =
                  this.elem && (void 0 !== this.target.style[o.p] || a[o.p])),
                o.css &&
                  a[o.p] &&
                  !r._gsTransform &&
                  t.set(r, {
                ...
                (o.type =
                  i || (o.css && 0 === e.indexOf("rotation")) ? "deg" : ""),
                (o.v1 = o.v2 = o.css ? h(r, o.p) : s ? r[o.p]() : r[o.p]));
            }
          }),
          ...
          (d.getVelocity = function (t) {
            ...
            return (
              (e = s.css ? h(n, s.p) : s.f ? n[s.p]() : n[s.p]),
              (i = e - s.v2),
              ("rad" === s.type || "deg" === s.type) &&
                ((r = "rad" === s.type ? 2 * Math.PI : 360),
                (i %= r),
                i !== i % (r / 2) && (i = 0 > i ? i + r : i - r)),
              i / (u.time - s.t2)
            );
          }),
          ...
          (p.untrack = function (t, i) {
            ...
            if (r) {
              ...
              (r._firstVP && i) ||
                (r._prev ? (r._prev._next = r._next) : r === e && (e = r._next),
